...
//                MtkCameraParameters::SCENE_MODE_NORMAL, 
                ...
                MtkCameraParameters::SCENE_MODE_BACKLIGHT,
                MtkCameraParameters::SCENE_MODE_BACKLIGHT_PORTAIT,
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "320x240",      "640x480",      "1024x768",     "1280x720",     "1280x768",     "1280x960",  "1600x912",   "1600x1200", 
                "1632x1224",    "2048x1152",   "2048x1536",    "2560x1440",    "2560x1920",    "3200x2400",    "3328x1872",  "3264x1840",
                "2880x1728",    "3264x2448", 
            )
        ), 
    )
    ...
    //  Posture detection
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_SUPPORTED(
        KEY_AS_(MtkCameraParameters::KEY_POSTURE_DETECTION), 
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(MtkCameraParameters::FALSE), 
            ITEM_AS_SUPPORTED_(
            #if 0
    ...
    //  Smart de-noise
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_SUPPORTED(
        KEY_AS_(MtkCameraParameters::KEY_SMART_DENOISE), 
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(MtkCameraParameters::FALSE), 
            ITEM_AS_SUPPORTED_(
            #if 0
    ...
    //==========================================================================
#if 1
    //  Smart noise reduce for night hawk
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_SUPPORTED(
        KEY_AS_(MtkCameraParameters::KEY_NOISE_REDUCTION), 
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(MtkCameraParameters::FALSE), 
            ITEM_AS_SUPPORTED_(
            #if 0
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                MtkCameraParameters::CAPTURE_MODE_BRIGHT_MAGIC,
            )
        ), 
    )
#endif
